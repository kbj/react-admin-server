...
type Menu struct {
	...
	OrderNum       int            `json:"orderNum" validate:"required" comment:"菜单顺序" gorm:"comment:排序;not null;default:0"`
	...
	Enabled        string         `json:"enabled" gorm:"comment:是否启用;not null;default:1;size:1"`
